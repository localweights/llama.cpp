...
enum llm_kv {
    ...
    LLM_KV_MTP_EXPERT_FEED_FORWARD_LENGTH,
    ...
    LLM_KV_QWEN3MOE_ASSISTANT_N_EMBD_BACKBONE,
    LLM_KV_QWEN3MOE_ASSISTANT_REQUIRES_TARGET_ARCH,
...
enum llm_tensor {
    ...
    LLM_TENSOR_MTP_PRE_PROJECTION_QWEN3MOE,
    LLM_TENSOR_MTP_POST_PROJECTION_QWEN3MOE,
};
