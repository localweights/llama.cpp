...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_QWEN3MOE_MTP,     "qwen3moe_mtp"     },
    { LLM_ARCH_PHI2,             "phi2"             },
    { LLM_ARCH_PHI3,             "phi3"             },
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_MTP_EXPERT_FEED_FORWARD_LENGTH,    "%s.mtp.expert_feed_forward_length"    },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_MTP_PRE_PROJECTION_QWEN3MOE,            "mtp.pre_projection" },
    { LLM_TENSOR_MTP_POST_PROJECTION_QWEN3MOE,           "mtp.post_projection" },
