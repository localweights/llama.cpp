...
// Gemma 4 MTP assistant graph builder.
...
// ---------------------------------------------------------------------------
// llm_build_gemma4_mtp — the actual draft graph builder
// ---------------------------------------------------------------------------
...
llm_build_gemma4_mtp::llm_build_gemma4_mtp(
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        // Per HF Gemma4AssistantForCausalLM: MTP cross-attention reads
        ...
        // Per HF Gemma4: even when attention_k_eq_v is True, V cache slot is written separately.
        // Always fetch V from the cache, not from K.
